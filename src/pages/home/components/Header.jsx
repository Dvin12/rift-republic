...
export default function Header() {
  return (
    <header className=" bg-[url('../public/images/home-phone.png')] xl:bg-[url('../public/images/home-desktop.png')] h-screen bg-cover  ">
      <section className="px-6 text-3xl xl:w-full xl:h-full py-36 xl:py-60 font-Koulen xl:px-44 xl:flex xl:flex-col">
      ...
      <section className="absolute bottom-0 px-6 xl:px-44 xl:bottom-12 ">
        <NewArrivals />
      </section>
    </header>
  );
